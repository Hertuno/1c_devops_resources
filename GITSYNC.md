# Информация по работе с библиотекой [gitsync](https://github.com/oscript-library/gitsync) - которая реализует основные классы для синхронизации хранилища 1С с git
...
### Для выгрузки при помощи свежих EDT (от 2024 версии) 
необходима версия плагина edtExport 1.4.0, её можно скачать из ветки разработки основного репозитория
...
### При первичной выгрузке, в дирректории выгрузки, нужно создать файл VERSION, с версией сборки хранилища от которой будет происходить выгрузка (если указать 0, хранилище выгрузится полностью)
```HTML
<?xml version="1.0" encoding="UTF-8"?>
<VERSION>0</VERSION>
```

### Для работы с длинными путями до директории выгрузки (напр. "D:\git\local_edt\src\ext\") на windows необходимо использовать версию Onescript 2.0+
